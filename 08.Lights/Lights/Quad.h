...
public:
	...
	void render(const unsigned int SCR_WIDTH, const unsigned int SCR_HEIGHT, glm::vec3 offset, float size, float rotationAngle, glm::vec3 rotationAxis, glm::vec3 objectColor, glm::vec3 lightPosition) {
