...
void Plane::loadTextureFromDisk(std::string file) {
...
void Plane::generateObj() {
	float vertices[] = {
		//Position         //Texture coordinates
		 1.f,  3.f, 0.f, 1.0f, 1.0f, // top right
		 1.f, -1.f, 0.f, 1.0f, 0.0f, // bottom right
		-1.f, -1.f, 0.f, 0.0f, 0.0f, // bottom left
		-1.f,  3.f, 0.f, 0.0f, 1.0f,  // top left
	};
...
void Plane::render(const unsigned int SCR_WIDTH, const unsigned int SCR_HEIGHT){
	...
	float offset = 0;//timeValue / 4;

	//Set uniforms
	(*shaderForDraw).use();
	(*shaderForDraw).setFloat("offset", offset);
